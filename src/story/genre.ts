...
export const GENRES: GenreSpec[] = [
  ...
  },
  {
    ...
    persona: "都市小说",
    worldGuidance:
      "现代都市为舞台，【不含超自然/异能】，一切遵循现实逻辑；主角的优势来自财富、人脉、专业本领（商战、医术、鉴宝、厨艺、娱乐、法律等）、眼光与心性；势力为商业集团、豪门世家、行业圈子、市井江湖；关键信物为合同股权、身份、名器珍藏、人情筹码；冲突源于名利、情感、阶层与家族博弈。",
    styleGuidance: "节奏明快、现代口语，接地气有烟火气；爽感来自现实层面的逆袭、打脸与人情练达，不写超能力。",
  },
  {
    id: "urban-esper",
    label: "都市异能",
