...
export class Novelist {
  ...
  async write(
    ...
    const system = [
      ...
      "- 人物的能力/生理状态一律以其【身份·性格·说话风格设定】为准，【不要仅凭名字或诨号臆断】——例如某角色名号里带「哑」字，但其设定明明是絮叨健谈，那他就是会说话的人，绝不能反而把他写成不能开口的哑巴。切勿凭名字硬安一个与设定相反的特征。",
      "- 一旦人物确有某项生理限制（设定写明哑/盲/聋/重伤/昏迷等），就贯彻到底、绝不同章推翻：真哑者不写出成句台词（改以手势、书写、眼神、喉间呜咽或动作表意），也不要一边旁白说他不会说话、一边又给他写对白。",
      "- 细节与来历务必【逻辑自洽】：人物为何在此、为何持有某物、其身份与言行是否吻合，都要交代得通、前后一致。绝不要抛出互相矛盾或讲不通的身世细节（例如同一件信物一会儿说是甲挂上、一会儿又说是乙塞回，却给不出合理缘由；或人物身份与其所持信物、称谓自相打架）。宁可少写来历，也不要写出经不起推敲的交代。",
